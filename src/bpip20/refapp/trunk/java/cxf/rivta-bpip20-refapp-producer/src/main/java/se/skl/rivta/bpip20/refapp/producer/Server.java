...
package se.skl.rivta.bpip20.refapp.producer;
...
public class Server {
	...
	static public void main(String[] args) throws Exception {
		...
		logger.info("RIV TA Basic Profile med Intygspropagring v2.0 - Ref App, Apache CXF Producer running on Java version {}", System.getProperty("java.version"));
