...
@REM 
@REM --------------------------------------------------------------------------
svcutil.exe /language:cs /out:generated-src\EhrExtractionResponderProxy.cs /config:generated-src\app.config /namespace:urn:riv:ehr:ehrexchange:EhrExtraction:1:rivtabp20,rivta_bp20_refapp_schemas.wsdl /namespace:urn:riv:ehr:ehrexchange:EhrExtraction:1,rivta_bp20_refapp_schemas.xsd business\JournalinfoApoteketRIV\EhrExtractionInteraction.wsdl business\JournalinfoApoteketRIV\*.xsd  technical\wsaddressing\ws-addressing-1.0.xsd
