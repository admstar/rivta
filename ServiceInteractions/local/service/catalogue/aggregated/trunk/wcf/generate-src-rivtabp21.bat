...
SET OUTFILE=/out:wcf\generated-src\ServiceCatalogueInteractions.cs
...
CD wcf
ECHO Generating Service contract .Net Binding interfaces and classes for service:catalogue Release 1
