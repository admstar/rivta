...
SET W0=%SCHEMADIR%\interactions\ProcessObservationsInteraction\ProcessObservationsInteraction_1.0_RIVTABP21.wsdl
 
SET X0=%SCHEMADIR%\interactions\ProcessObservationsInteraction\*.xsd
 
SET W1=%SCHEMADIR%\interactions\DeleteObservationsInteraction\DeleteObservationsInteraction_1.0_RIVTABP21.wsdl

SET X1=%SCHEMADIR%\interactions\DeleteObservationsInteraction\*.xsd
