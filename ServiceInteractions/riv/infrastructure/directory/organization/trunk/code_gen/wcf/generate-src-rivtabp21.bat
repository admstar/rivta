	...
	SET OUTFILE=/out:wcf\generated-src\InfrastructureDirectoryOrganizationInteractions.cs
	SET APPCONFIG=/config:wcf\generated-src\app.config
	SET NAMESPACE=/namespace:*,Riv.Infrastructure.Directory.Organization.Schemas.v1
	SET SVCUTIL="svcutil.exe"
	%SVCUTIL% /language:cs %OUTFILE% %APPCONFIG% %NAMESPACE% %SCHEMAS%

	CD wcf
	ECHO Generating Service contract .Net Binding interfaces and classes for infrastructure:directory:organization Release 1
