	...
	SET W0=%SCHEMADIR%\interactions\GetLogicalAddresseesByServiceContractInteraction\GetLogicalAddresseesByServiceContractInteraction_1.0_RIVTABP21.wsdl
SET X0=%SCHEMADIR%\interactions\GetLogicalAddresseesByServiceContractInteraction\*.xsd

SET W1=%SCHEMADIR%\interactions\GetSupportedServiceContractsInteraction\GetSupportedServiceContractsInteraction_1.0_RIVTABP21.wsdl
