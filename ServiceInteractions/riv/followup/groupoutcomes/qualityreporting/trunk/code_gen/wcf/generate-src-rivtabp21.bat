...
@REM file for the WSDLs + XML Schemas of the service domain, using .Net WCF tool svcutil.exe
...
CD wcf
ECHO Generating Service contract .Net Binding interfaces and classes for followup:groupoutcomes:qualityreporting Release 1
