...
SET W0=%SCHEMADIR%\interactions\GetEhrExtractInteraction\GetEhrExtractInteraction_1.0_RIVTABP21.wsdl
SET X0=%SCHEMADIR%\interactions\GetEhrExtractInteraction\*.xsd
...
SET OUTFILE=/out:wcf\generated-src\PatientsummaryInteractions.cs
