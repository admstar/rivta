...
SET OUTFILE=/out:generated-src\EhrLogInteractions.cs
SET APPCONFIG=/config:generated-src\app.config
SET NAMESPACE=/namespace:*,Riv.Ehr.Log.Schemas.v1
SET SCHEMADIR="..\..\schemas"
SET SVCUTIL="svcutil.exe"
	
SET W1=%SCHEMADIR%\interactions\LogInteraction\LogInteraction_1.0_RIVTABP21.wsdl
SET X1=%SCHEMADIR%\interactions\LogInteraction\*.xsd
