	...
	SET W0=%SCHEMADIR%\.\interactions\AssertCareEngagementInteraction\AssertCareEngagementInteraction_1.0_RIVTABP20.wsdl
SET X0=%SCHEMADIR%\interactions\AssertCareEngagementInteraction\*.xsd
...
CD wcf
ECHO Generating Service contract .Net Binding interfaces and classes for ehr:accesscontrol Release 1
