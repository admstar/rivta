	...
	SET W0=%SCHEMADIR%\interactions\accesscontrol\CheckPatientRelationInteraction\CheckPatientRelationInteraction_1.0_RIVTABP21.wsdl
SET X0=%SCHEMADIR%\interactions\CheckPatientRelationInteraction\*.xsd
...
SET X1=%SCHEMADIR%\interactions\CancelExtendedPatientRelationInteraction\*.xsd
...
SET X2=%SCHEMADIR%\interactions\DeleteExtendedPatientRelationInteraction\*.xsd
...
SET X3=%SCHEMADIR%\interactions\GetExtendedPatientRelationsForPatientInteraction\*.xsd
...
SET X4=%SCHEMADIR%\interactions\RegisterExtendedPatientRelationInteraction\*.xsd
...
SET X5=%SCHEMADIR%\interactions\GetPatientRelationsForCareProviderInteraction\*.xsd
...
SET X6=%SCHEMADIR%\interactions\GetPatientRelationsForPatientInteraction\*.xsd

SET XCORE=%SCHEMADIR%\core_components\*.xsd

SET SCHEMAS=%XCORE% %W0% %X0% %W1% %X1% %W2% %X2% %W3% %X3% %W4% %X4% %W5% %X5% %W6% %X6% 

SET OUTFILE=/out:wcf\generated-src\EhrPatientrelationInteractions.cs
SET APPCONFIG=/config:wcf\generated-src\app.config
SET NAMESPACE=/namespace:*,Riv.Ehr.Patientrelation.Schemas.v1
SET SVCUTIL="svcutil.exe"
%SVCUTIL% /language:cs %OUTFILE% %APPCONFIG% %NAMESPACE% %SCHEMAS%

CD wcf
ECHO Generating Service contract .Net Binding interfaces and classes for ehr:patientrelation Release 1
