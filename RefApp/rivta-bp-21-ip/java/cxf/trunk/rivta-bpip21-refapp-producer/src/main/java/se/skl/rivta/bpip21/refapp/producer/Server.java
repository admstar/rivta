...
package se.skl.rivta.bpip21.refapp.producer;
...
import se.skl.rivta.bpip21.refapp.producer.makebooking.Responder;
...
public class Server {
	...
	static public void main(String[] args) throws Exception {
		...
		logger.info("RIV TA Basic Profile med Intygspropagring v2.1 - Ref App, Apache CXF Producer running on Java version {}", System.getProperty("java.version"));
