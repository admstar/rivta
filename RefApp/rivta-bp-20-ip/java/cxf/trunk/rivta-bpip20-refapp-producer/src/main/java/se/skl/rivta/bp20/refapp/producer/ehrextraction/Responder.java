...
import se.skl.riv.ehr.ehrexchange.getehrextractresponder.v1.GetEhrExtractContinuationRequestType;
import se.skl.riv.ehr.ehrexchange.getehrextractresponder.v1.GetEhrExtractContinuationResponseType;
...
import se.skl.riv13606.v2.TS;
import se.skl.rivta.bp20.refapp.util.Util;

@WebService(
	serviceName = "GetEhrExtractResponderService", 
	endpointInterface="se.skl.riv.ehr.ehrexchange.getehrextract.v1.rivtabpip20.GetEhrExtractResponderInterface", 
	portName = "GetEhrExtractResponderPort", 
	targetNamespace = "urn:riv:ehr:ehrexchange:GetEhrExtract:1:rivtabpip20",
	wsdlLocation = "schemas/interactions/GetEhrExtractInteraction_1.0_rivtabpip20.wsdl")
public class Responder implements GetEhrExtractResponderInterface {
