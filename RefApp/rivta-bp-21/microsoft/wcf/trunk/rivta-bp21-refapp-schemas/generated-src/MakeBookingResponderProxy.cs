...
[System.Xml.Serialization.XmlTypeAttribute(Namespace="urn:riv:interoperability:headers:1")]
public partial class ActorType
{
    
    private string actorIdField;
    
    private ActorTypeEnum actorTypeField;
...
public partial class TimeslotType
{
    ...
    private bool isInvitationFieldSpecified;
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlIgnoreAttribute()]
    public bool isInvitationSpecified
    {
        get
        {
            return this.isInvitationFieldSpecified;
        }
        set
        {
            this.isInvitationFieldSpecified = value;
        }
    }
...
namespace rivta_bp21_refapp_schemas.wsdl
{
    ...
    public partial class MakeBookingRequest
    {
        ...
        [System.ServiceModel.MessageHeaderAttribute(Namespace="urn:riv:interoperability:headers:1")]
        ...
        public MakeBookingRequest(string LogicalAddress, ActorType Actor, MakeBookingType MakeBooking)
        {
    ...
    public partial class MakeBookingResponderInterfaceClient : System.ServiceModel.ClientBase<rivta_bp21_refapp_schemas.wsdl.MakeBookingResponderInterface>, rivta_bp21_refapp_schemas.wsdl.MakeBookingResponderInterface
    {
        ...
        public string MakeBooking(string LogicalAddress, ActorType Actor, MakeBookingType MakeBooking1, out ResultCodeEnum resultCode, out string resultText, out System.Xml.XmlElement[] Any)
        {
