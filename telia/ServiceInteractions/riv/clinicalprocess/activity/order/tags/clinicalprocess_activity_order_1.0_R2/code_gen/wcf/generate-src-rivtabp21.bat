...
SET W1=%SCHEMADIR%\.\interactions\ProcessActivityOrderInteraction\ProcessActivityOrderInteraction_1.0_RIVTABP21.wsdl
SET X1=%SCHEMADIR%\interactions\ProcessActivityOrderInteraction/\*.xsd

SET XCORE=%SCHEMADIR%\core_components\*.xsd

SET SCHEMAS=%XCORE% %W0% %X0%

SET OUTFILE=/out:wcf\generated-src\ClinicalprocessActivityOrder.cs
SET APPCONFIG=/config:wcf\generated-src\app.config
SET NAMESPACE=/namespace:*,Riv.Clinicalprocess.Activity.Order.v1
